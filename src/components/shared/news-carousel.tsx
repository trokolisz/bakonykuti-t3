                ...
                <div className="md:flex bg-card rounded-lg overflow-hidden">
	                  ...
	                  <div className="relative w-full h-48 md:h-64 flex-shrink-0">
	                    ...
	                    <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
	                      <h2 className="px-4 text-center text-white text-lg font-semibold line-clamp-2 break-words">
	                        {item.title}
	                      </h2>
	                    </div>
	                  </div>
                    ...
                    <CardHeader className="md:px-0">
	                      <CardTitle className="text-2xl font-bold leading-tight line-clamp-2 break-words">
                        {item.title}
                      </CardTitle>
                    ...
                    <CardContent className="md:px-0"></CardContent>
	                    <CardContent className="md:px-0">
	                      <div className="text-muted-foreground line-clamp-3 markdown text-base break-words">
                        <ReactMarkdown
